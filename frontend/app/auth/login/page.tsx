...
import { loginUser, saveCurrentUser } from "@/lib/user-store";
...
export default function LoginPage() {
  ...
  useEffect(() => {
    getSystemStatus()
      ...
      .catch(() => {
        setSystemStatus("activated"); // 默认显示登录表单
      });
  }, []);
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <h1 className="text-5xl font-bold mb-6 leading-tight">
            让数据<br />
            <span className="text-white/80">讲述商业故事</span>
          </h1>
          <p className="text-xl text-white/80 mb-8 max-w-md">
            智能 BI 分析平台，帮助您快速洞察数据价值，驱动业务增长决策
          </p>
