...
export default function FloatingSettingsButton() {
  ...
  return (
    <>
      ...
      {/* Tooltip */}
      {showTooltip && (
        <div className="fixed bottom-24 right-6 bg-zinc-800 text-white text-sm px-4 py-2 rounded-lg shadow-lg border border-zinc-700 animate-fade-in z-50">
          设置
          <div className="absolute bottom-0 right-6 translate-y-1/2 rotate-45 w-2 h-2 bg-zinc-800 border-b border-r border-zinc-700" />
        </div>
      )}
    </>
  );
