...
func mustExecTx(tx *sql.Tx, stmt string, args ...any) {
	if _, err := tx.ExecContext(context.Background(), stmt, args...); err != nil {
...
func main() {
	...
	// seed categories
	mustExecTx(tx, `INSERT INTO categories (id, name, parent_id) VALUES
        (1, '电子产品', NULL),
        (2, '手机', 1),
        (3, '笔记本电脑', 1),
        (4, '配件', 1),
	...
	// seed customers (5)
	mustExecTx(tx, `INSERT INTO customers (name, email, phone, city, province, registered_at, vip_level) VALUES
	...
	// seed products (6)
	mustExecTx(tx, `INSERT INTO products (id, name, category_id, price, cost, stock, status, created_at) VALUES
	...
	mustExecTx(tx, `INSERT INTO orders (order_no, customer_id, total_amount, discount_amount, pay_amount, status, payment_method, created_at, paid_at) VALUES
	...
	// seed order items
	mustExecTx(tx, `INSERT INTO order_items (order_id, product_id, quantity, unit_price, subtotal) VALUES
